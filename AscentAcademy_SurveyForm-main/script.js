...
function data(){
    ...
    if(element[8].checked && element[6].checked){skills.innerHTML="SKILLS: ReactJS,CSS";}
    if(element[8].checked && element[7].checked){skills.innerHTML="SKILLS: ReactJS,JS";}
    if(element[5].checked && element[6].checked && element[7].checked){skills.innerHTML="SKILLS: HTML,CSS,JS";}
    if(element[5].checked && element[6].checked && element[8].checked){skills.innerHTML="SKILLS: HTML,CSS,ReactJS";}
    if(element[5].checked && element[7].checked && element[8].checked){skills.innerHTML="SKILLS: HTML,JS,ReactJS";}
